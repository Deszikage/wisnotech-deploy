...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 pt-16 noise-overlay" data-testid="register-page">
      <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-amber-500/6 rounded-full blur-[120px]" />
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2" style={{ fontFamily: 'Outfit' }}>Join WISNOTECH</h1>
        ...
        <div className="rounded-2xl bg-slate-900/60 border border-slate-800 p-8">
          {error && (
            <div className="mb-4 p-3 bg-red-500/10 border border-red-500/20 rounded-lg text-red-400 text-sm" data-testid="register-error">
              {error}
            </div>
          )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Your full name" data-testid="register-name"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="you@example.com" data-testid="register-email"
                  className="w-full bg-slate-950/50 border border-slate-800 rounded-lg pl-11 pr-4 h-12 text-white text-sm placeholder:text-slate-500 focus:outline-none focus:border-blue-500"
                />
              </div>
            </div>
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            Already have an account? <Link to="/login" className="text-blue-400 hover:underline" data-testid="goto-login">Log in here</Link>
          </p>
        </div>
      </div>
    </div>
